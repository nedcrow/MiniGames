...
public class M3TileMapComponent : TileMapComponent
{
    [Header("Match3 Properties")]
    public ETileType[] currentUsingTypes;
    ...
    public override void UpdateTileMap(int sizeX, int sizeY)
    {
        ...
        foreach(GameObject tileObj in tileObjectList)
        {
            ...
            tileComp.ChangeTileType((ETileType) currentUsingTypes.GetValue(
    ...
    protected void ChangeTileType(GameObject tile, ETileType tileType)
    {
